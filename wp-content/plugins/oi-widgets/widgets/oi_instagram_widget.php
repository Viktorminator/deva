...
class OI_Instagram_Widget extends WP_Widget {
	...
	function OI_Instagram_Widget() {
		...
		$widget_ops = array(	'classname'		=> 'ct-instagram-widget',
								'description'	=> __( 'CT: Instagram Widget', 'qoon-creative-wordpress-portfolio-theme' )
							);
...
function form( $instance ) {
	...
	$defaults = array(	'title'				=> __( 'Instagram Feed' , 'qoon-creative-wordpress-portfolio-theme' ),
						'access_token'		=> '',
						'client_id'			=> '',
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'client_id' ); ?>"><?php _e('Your Instagram application clientID:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'access_token' ); ?>"><?php _e('Your Instagram access token:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'your_query' ); ?>"><?php _e('Query (user name or tag):', 'qoon-creative-wordpress-portfolio-theme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'num_images' ); ?>"><?php _e('The number of displayed images:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e('Items Per Row:', 'qoon-creative-wordpress-portfolio-theme'); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'feed_type' ); ?>"><?php _e('Feed type:', 'qoon-creative-wordpress-portfolio-theme'); ?></label> 
