...
class OI_About_Widget extends WP_Widget {
	...
	function OI_About_Widget() {
		...
		$widget_ops = array(	'classname'		=> 'oi-about-widget',
								'description'	=> __( 'OI: About Widget', 'qoon-creative-wordpress-portfolio-theme' )
							);
...
function form( $instance ) {
	...
	$defaults = array(	'title'				=> __( 'About Me' , 'qoon-creative-wordpress-portfolio-theme' ),
						'main_background'	=> '',
						'main_content'	=> ''
					);
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'main_background' ); ?>"><?php _e('Backdround Image URL:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'main_content' ); ?>"><?php _e('Content:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
