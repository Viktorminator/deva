 ...
 */
	...
	function OrangeIdea_Popular_Posts_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array('classname' => 'OrangeIdea_popular_post_widget', 'description' => __( 'OrangeIdea: Popular Posts', 'qoon-creative-wordpress-portfolio-theme' ) );
...
function form( $instance ) {
	...
	$defaults = array( 'title' => __( 'Popular Posts' , 'qoon-creative-wordpress-portfolio-theme' ), 'number_of_posts_to_show' => '3' );
